...
async def cmd_start(message: types.Message):
    await message.answer(
        "Привет! Я бот, который может общаться с ChatGPT и транскрибировать аудио и видео.\n\n"
        "Отправь мне сообщение, аудиофайл или видео, и я обработаю его. "
...
async def cmd_queue(message: types.Message):
    """Отображает текущую очередь задач на обработку аудио и видео"""
    ...
    queue_info = f"📋 <b>Статус очереди обработки аудио и видео:</b>\n\n"
...
• Отправьте видеофайл для извлечения и транскрибации аудиодорожки
• При транскрибации аудио/видео вы получите текст и файл с транскрибацией
...
Этот бот позволяет общаться с ChatGPT и транскрибировать аудио и видео с помощью технологии Whisper.
...
<b>Особенности:</b>
• Поддержка транскрибации голосовых сообщений и аудиофайлов
• Поддержка транскрибации видео (извлечение и транскрибация аудиодорожки)
