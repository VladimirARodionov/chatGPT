...
- Для обычной установки Local Bot API на том же сервере: `LOCAL_BOT_API_FILES_PATH=/var/lib/telegram-bot-api`
- Для Docker с общим томом: `LOCAL_BOT_API_FILES_PATH=/data/telegram-bot-api` (зависит от настроек монтирования томов)
